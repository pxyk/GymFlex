  ...
  return (
    <>
      <section>
        ...
        <div className="bg-white py-[12rem] page-padding grid grid-cols-2 container gap-10 items-center md1000:grid-cols-1 ">
          ...
          <div className="md1000:w-[60%] md1000:flex md1000:flex-col md1000:mx-auto min800:w-[90%] min620:w-full">
            ...
            <p className="text-[16px] w-[95%] text-[#646464] font-medium my-[40px]">
              At GymFlex, we are dedicated to helping you achieve the body of
        ...
        {/* map */}
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12047.741850819197!2d29.020857!3d40.982894!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cab88a6b1a7fc5%3A0x2a8426d49e0a222a!2zTW9kYSBTYWhpbCBQYXJrxLEgdmUgWcO8csO8ecO8xZ8gWW9sdQ!5e0!3m2!1str!2sus!4v1692367676487!5m2!1str!2sus"
          allowFullScreen=""
          loading="lazy"
          samesite="Strict"
          title="map"
